-- Set up founding_seats on the spvkehpninpezvkkzknm Supabase project
-- (the app moved off Lovable Cloud to Vercel + user-owned Supabase).
...
DROP POLICY IF EXISTS "Anyone can view founding seats" ON public.founding_seats;
...
-- Realtime so every visitor's page updates the moment a seat is claimed.
